        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::user() && Auth::user()->isAdmin() ? route('admin.dashboard') : route('dashboard') }}">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                ...
                                <div class="ml-2 text-xs px-2 py-1 rounded-full {{ Auth::user()->getRoleBadgeColor() }}">
                        ...
                        <x-slot name="content">
                            <div class="px-4 py-2 text-xs text-gray-500 border-b">
                                Logged in as: <span class="{{ Auth::user()->getRoleBadgeColor() }} px-2 py-1 rounded-full">{{ Auth::user()->getRoleDisplayName() }}</span>
                            </div>
                            <!-- Authentication -->
        ...
        @auth
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="px-4">
                    ...
                    <div class="text-xs mt-1 {{ Auth::user()->getRoleBadgeColor() }} px-2 py-1 rounded-full inline-block">
                        {{ Auth::user()->getRoleDisplayName() }}
                    </div>
                </div>
